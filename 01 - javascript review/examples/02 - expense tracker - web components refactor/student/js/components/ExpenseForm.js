// start with expese-form
// then expense-search
//and expense-list 
// these will be th components that we make.

// start by breaking the expense form into one piece
// make a folder for the components
// then make a file for each component

// make a skeleton for the component
// expense form extends HTML Element
// then 

class ExpenseForm extends HTMLElement {
    //nothing yet
    /*wheat do i need in here?
    - render - a method to render HTML 
    -connectedCallback - what should happen when the element loads
    - form-specific logic */
...
customElements.define('expense-form', ExpenseForm) // html - name ('html-name', ClassName)